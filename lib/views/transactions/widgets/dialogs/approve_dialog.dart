...
void showApproveDialog(BuildContext context, Transaction tx,
    ...
    child: ConstrainedBox(
      ...
      child: Padding(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Lottie.network(lottieApproved, width: 80, height: 80,
              repeat: false,
              errorBuilder: (_, __, ___) => const Icon(
                  Icons.check_circle_rounded, size: 56, color: colApproved)),
          ...
          Text(Formatters.formatCurrency(tx.amountBdt),
              style: const TextStyle(fontSize: 20,
                  fontWeight: FontWeight.w800, color: colApproved)),
